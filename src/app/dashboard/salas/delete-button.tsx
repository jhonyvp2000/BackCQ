...
import { deleteOperatingRoom } from "@/app/actions/salas";
...
export function DeleteRoomButton({ id }: { id: string }) {
    ...
    const handleDelete = async () => {
        ...
        const result = await deleteOperatingRoom(formData);
    ...
    return (
        <>
            <button
                ...
                className="text-red-500 hover:text-red-700 bg-red-50 hover:bg-red-100 p-2 rounded-lg transition-colors shadow-sm ml-2"
                title="Eliminar Sala"
            >
                <Trash2 size={16} />
            </button>
                            ...
                            >
                                ...
                                <div className="flex flex-col items-center text-center">
                                    ...
                                    <h3 className="text-lg font-bold text-zinc-900 dark:text-white mb-2">
                                        ¿Eliminar Sala Quirúrgica?
                                    </h3>
                                    <p className="text-sm text-zinc-500 dark:text-zinc-400 mb-6 px-2">
                                        Esta acción eliminará de forma permanente la sala de operaciones del sistema. No se puede deshacer.
                                    </p>
